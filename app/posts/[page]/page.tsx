    ...
    <>
      <div className="mx-auto max-w-7xl p-6">
        <div className="flex justify-between item-center mb-6">
          ...
          {sessions && (
            <Link href="/write" className="shadow px-4 py-2 rounded-md">
              글쓰기
            </Link>
          )}
        </div>
        <div className="bg-white shadow-md rounded-lg">
          <div className="min-w-full">
            <ul className="bg-gray-800 text-white flex justify-between">
              <li className="px-6 basis-2/12 py-3 text-center font-bold">
                번호
              </li>
              <li className="px-6 basis-6/12 py-3 text-center font-bold">
                제목
              </li>
              <li className="px-6 basis-2/12 py-3 text-center font-bold">
                작성자
